...
import org.openqa.selenium.support.ui.WebDriverWait;
	public class BrowserStackDemo {
	  public static final String AUTOMATE_USERNAME = "fahimpaikar_qEvm5u";
	  public static final String AUTOMATE_ACCESS_KEY = "UbV8jzqPA7sDAg6S9ea4";
	  ...
	  public static void main(String[] args) throws Exception {
	    ...
	    element.sendKeys("2021 Acura RDX");
	    element.submit();
